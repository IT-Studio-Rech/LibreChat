...
export default function Conversation({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        'group relative flex h-12 w-full items-center rounded-brand-sm outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-black dark:focus-visible:ring-white md:h-9',
        isActiveConvo || isPopoverActive
          ? 'bg-brand-rose-cream text-text-headline'
          : 'hover:bg-cream-dark',
      )}
      role="button"
